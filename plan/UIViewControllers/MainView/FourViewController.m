...
- (UIView *)createTableHeaderView {
    CGFloat viewHeight = HEIGHT_FULL_VIEW / 3;
    SDCycleScrollView *cycleScrollView2 = [SDCycleScrollView cycleScrollViewWithFrame:CGRectMake(0, 320, WIDTH_FULL_SCREEN, viewHeight) imageURLStringsGroup:nil]; // 模拟网络延时情景
