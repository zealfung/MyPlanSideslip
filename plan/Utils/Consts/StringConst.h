...
/** 计划 */
UIKIT_EXTERN NSString *const STRViewTitle2;
/** 任务 */
UIKIT_EXTERN NSString *const STRViewTitle3;
/** 个人中心 */
UIKIT_EXTERN NSString *const STRViewTitle4;
/** 岁月影像 */
UIKIT_EXTERN NSString *const STRViewTitle5;
/** 常见问题 */
UIKIT_EXTERN NSString *const STRViewTitle6;
/** 五星鼓励 */
UIKIT_EXTERN NSString *const STRViewTitle7;
/** 建议反馈 */
UIKIT_EXTERN NSString *const STRViewTitle8;
/** 关于我们 */
UIKIT_EXTERN NSString *const STRViewTitle9;
/** 注册账号 */
UIKIT_EXTERN NSString *const STRViewTitle10;
/** 找回密码 */
UIKIT_EXTERN NSString *const STRViewTitle11;
/** 消息中心 */
UIKIT_EXTERN NSString *const STRViewTitle12;
/** 消息详情 */
UIKIT_EXTERN NSString *const STRViewTitle13;
/** 小区 */
