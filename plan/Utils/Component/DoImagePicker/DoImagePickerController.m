...
- (void)initBottomMenu
{
    ...
    _ivLine1.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:png_Bg_Line]];
    _ivLine2.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:png_Bg_Line]];
